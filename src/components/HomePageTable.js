...
class HomePageTable extends React.Component{
	constructor(props){
		super(props)
		this.state={
			pages: ["getting started", "variables", "comments", "printing", "arithmetic", "strings", "user input", "math", "if statement", "boolean logic", "constants", "for loop", "while loop", "nesting", "break", "functions", "overloading", "array", "arraylist", "2d array", "casting", "random numbers", "ascii", "hashmap"],
			data: {}
		}
	}
